...
class FormularioArticulos:
    def __init__(self):
        ...
        self.ventana1=tk.Tk()
        self.ventana1.title("SYST_CONTROL(COMERCIAL DELFINA®)-(INVENTARIO Y STOCK)")
        self.ventana1.iconbitmap("COM_DELFINA.ico")
        self.ventana1.geometry("550x325")
    ...
    def consulta_por_codigo(self):
        ...
        self.cuaderno1.add(self.pagina2, text="Ingreso de Stock")
        self.labelframe2=ttk.LabelFrame(self.pagina2, text="Producto")
        self.labelframe2.grid(column=0, row=0, padx=5, pady=10)
        self.label1=ttk.Label(self.labelframe2, text="CÓD. BARRA:")
        self.label1.grid(column=0, row=0, padx=4, pady=4)
        ...
        self.label3=ttk.Label(self.labelframe2, text="CANTIDAD:", state="readonly")        
    ...
    def modificar(self):
        ...
        self.entryprecio=ttk.Entry(self.labelframe5, textvariable=self.cant)
        self.entryprecio.grid(column=1, row=2, padx=4, pady=4)
        self.boton1=ttk.Button(self.labelframe5, text="CONSULTAR", command=self.consultar_mod)
        self.boton1.grid(column=1, row=3, padx=4, pady=4)
        self.boton2=ttk.Button(self.labelframe5, text="SINCRONIZAR STOCK", command=self.modifica)
        self.boton2.grid(column=1, row=4, padx=4, pady=4)

    def modifica(self):
        datos=(self.cant.get(), self.codigomod.get())
        cantidad=self.articulo1.modificacion(datos)
        if cantidad==1:
            mb.showinfo("SYST_CONTROL(COMERCIAL DELFINA®)-->(ÉXITO)",
                                f"STOCK DEL PRODUCTO: \n"
